 ...
 *
 * For updates and bugfixes, see http://github.com/magnuss/java FilterBloom
 *
 * Inspired by the Simpl FilterBloom-class written by Ian Clarke. This
...
public class FilterBloom<E> implements Serializable {
     ...
     */
    public FilterBloom(double falsePositiveProbability, int expectedNumberOfElements) {
     ...
     */
    public FilterBloom(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, BitSet filterData) {
